...
final class ConstructValueTests: XCTestCase {
  ...
  func testConstructObjectIdentifier() throws {
    XCTAssertNoThrow(try ASN1ObjectIdentifier(oid: "0.2.840.10045.3.1.7"))
    XCTAssertNoThrow(try ASN1ObjectIdentifier(oid: "1.2.840.10045.3.1.7"))
    XCTAssertNoThrow(try ASN1ObjectIdentifier(oid: "2.2.840.10045.3.1.7"))
    XCTAssertNoThrow(try ASN1ObjectIdentifier(oid: "3.2.840.10045.3.1.7"))
    XCTAssertNoThrow(try ASN1ObjectIdentifier(oid: "3.39.840.10045.3.1.7"))
    XCTAssertNoThrow(try ASN1ObjectIdentifier(oid: "3.0.840.10045.3.1.7"))
    XCTAssertNoThrow(try ASN1ObjectIdentifier(oid: "3.15.840.10045.3.1.7"))
    XCTAssertThrowsError(try ASN1ObjectIdentifier(oid: "4.2.840.10045.3.1.7"))
    XCTAssertThrowsError(try ASN1ObjectIdentifier(oid: "42.2.840.10045.3.1.7"))
    XCTAssertThrowsError(try ASN1ObjectIdentifier(oid: "128.2.840.10045.3.1.7"))
    XCTAssertThrowsError(try ASN1ObjectIdentifier(oid: "3.40.840.10045.3.1.7"))
    XCTAssertThrowsError(try ASN1ObjectIdentifier(oid: "3.200.840.10045.3.1.7"))
